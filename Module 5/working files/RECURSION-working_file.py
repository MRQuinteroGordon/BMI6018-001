    ...
    if len(nestlist) == 0:
        ...
        for element in nestlist:
            ...
            if not isinstance(element, (int, list)):
                print("The element is not an integer or list.  List can only contain integers or other lists.  Try again.")
                return
...
print("List 5:")
traverse_nest(list5)
# print("address of innermost list: ", leaf_address)
# print("length traversed: ", longest)
# trav_nest(2.14)
